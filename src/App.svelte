...
<div class="relative min-h-screen overflow-hidden font-sans">
  ...
  >
    ...
    >
      <div
        class="flex items-center gap-2 font-semibold tracking-wide text-slate-900"
      >
        <img src="logo.png" alt="Sub Vysion logo" class="h-8 w-auto" />
        <span>Sub Vysion</span>
      </div>
      <nav
        class="hidden items-center gap-6 text-sm font-medium text-slate-700 md:flex"
      >
        <a class="hover:text-teal-700" href="#workflow">Workflow</a>
        <a class="hover:text-teal-700" href="#platform">Platform</a>
        <a class="hover:text-teal-700" href="#pricing">Pricing</a>
        <a class="hover:text-teal-700" href="#trusted">Trusted</a>
      ...
      <div class="flex items-center gap-3">
        ...
        >
        <a
          class="inline-flex items-center gap-2 rounded-xl border border-transparent bg-teal-700 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-teal-500/20 transition hover:-translate-y-0.5 hover:bg-teal-800"
  ...
  <main class="relative z-10">
    <section class="py-14 sm:py-16">
      <div
        class="mx-auto grid max-w-6xl items-center gap-10 px-6 md:grid-cols-[1.05fr_0.95fr]"
      >
        <div class="space-y-5">
          <p
          ...
          >
            Mapping intelligence for construction and utilities
          </p>
          <h1
            class="text-4xl font-display font-semibold leading-tight text-slate-900 sm:text-5xl"
          >
            See every buried asset before you dig.
          </h1>
          <p class="text-lg text-slate-600">
            Sub Vysion combines AR overlays with ground-penetrating radar and
            computer vision so crews can visualize hidden infrastructure,
            validate as-builts, and hand off clean data without slowing work.
          </p>
          <div class="flex flex-wrap gap-3">
            <a
              class="inline-flex items-center gap-2 rounded-xl border border-teal-700 bg-teal-700 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-500/25 transition hover:-translate-y-0.5 hover:bg-teal-800"
              href="https://subvysion.setmore.com/services/71a943e6-77b0-4cdb-934f-de94600a9bb5"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300"
              href="#workflow"
            >
              See how it works
            </a>
          ...
          <ul class="space-y-2 text-sm text-slate-700">
            <li class="flex items-start gap-2">
              ...
              <span
                >Live AR overlays powered by GPR, computer vision, and RTK
                within 5 cm.</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="mt-1 h-2 w-2 rounded-full bg-teal-600"></span>
              <span
                >Field-to-cloud sync for inspections, sections, and redlines.</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="mt-1 h-2 w-2 rounded-full bg-teal-600"></span>
              <span
                >Crew-ready hardware built to survive dust, rain, and long
                deployments.</span
              >
            </li>
          </ul>
        ...
        <div class="space-y-4">
          <div
            class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-card"
          >
            <img
              src="header.png"
          ...
          >
            <div>
              <p class="text-xl font-semibold text-slate-900">12 min</p>
              <p class="text-xs uppercase tracking-wide">to map a block</p>
            </div>
            <div>
              <p class="text-xl font-semibold text-slate-900">-38%</p>
              <p class="text-xs uppercase tracking-wide">rework from strikes</p>
            </div>
            <div>
              <p class="text-xl font-semibold text-slate-900">5 cm</p>
              <p class="text-xs uppercase tracking-wide">positional accuracy</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-12 sm:py-14" id="workflow">
      <div class="mx-auto max-w-6xl px-6">
        ...
        >
          <div>
            ...
            >
              From Field Scan to Jobsite Action.
            </h2>
          </div>
        </div>
        <div class="mt-6 grid gap-4 md:grid-cols-3">
          <div
            class="flex h-full flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"
          >
            <div class="flex items-center gap-3">
            ...
            <p class="text-slate-600">
              Request a Sub Vysion crew to survey your job site. Our
              ground-penetrating radar and 3D capture systems deliver a precise,
              authoritative map and 3D digital twin of your location.
            </p>
            <div
              class="mt-auto overflow-hidden rounded-lg border border-slate-200"
            >
              <img
                src="map.jpg"
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <h3 class="text-lg font-semibold text-slate-900">View</h3>
            </div>
            <p class="text-slate-600">
              Review the overlay in AR on site or on the web; toggle layers,
              validate segments, and share with inspectors and subs.
            </p>
            <div
              class="mt-auto overflow-hidden rounded-lg border border-slate-200"
            >
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <h3 class="text-lg font-semibold text-slate-900">Dig</h3>
            </div>
            <p class="mt-2 text-slate-600">
              Break ground with confidence—crews avoid underground artifacts
              using the live overlay and up-to-date as-builts.
            </p>
            <div
              class="mt-auto overflow-hidden rounded-lg border border-slate-200"
            >
    ...
    <section class="py-12 sm:py-14" id="platform">
      <div class="mx-auto max-w-6xl px-6">
        <div class="space-y-3">
          <p
            class="inline-flex items-center gap-2 rounded-full bg-teal-100 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-teal-800"
          ...
          >
            One map that knows what is underground and where your crews are
            headed next.
          </h2>
          <p class="text-lg text-slate-600">
            Pair accurate positioning with live overlays to keep trenching,
            boring, and inspections predictable.
          </p>
        </div>
        <div class="mt-8 grid gap-4 md:grid-cols-3">
          ...
          >
            <div
              class="inline-flex w-fit items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700"
            >
              Cloud maps
            </div>
            <h3 class="text-xl font-semibold text-slate-900">
              View and manage maps in the cloud
            </h3>
            <p class="text-slate-600">
              Centralize every corridor, permit, and layer so teams work from
              one source of truth.
            </p>
            <ul class="mt-1 space-y-2 text-sm text-slate-600">
              <li>• Share web links for inspectors, subs, and owners.</li>
              <li>• Toggle layers for utilities, hazards, and notes.</li>
              <li>• Version history to track changes over time.</li>
            </ul>
          </article>
          <article
            class="flex h-full flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"
          >
            <div
              class="inline-flex w-fit items-center gap-2 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700"
            >
              AR mobile
            </div>
            <h3 class="text-xl font-semibold text-slate-900">
              View AR overlays on your phone
            </h3>
            <p class="text-slate-600">
              Align to RTK in the field, walk the route, and see underground
              assets overlaid in AR on iOS or Android.
            </p>
            <ul class="mt-1 space-y-2 text-sm text-slate-600">
              <li>• RTK-grade alignment and layer toggles.</li>
              <li>• Annotate cross sections with photos and notes.</li>
              <li>• Share AR sessions with crews and inspectors.</li>
            </ul>
          </article>
          <article
            class="flex h-full flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"
          >
            <div
              class="inline-flex w-fit items-center gap-2 rounded-full bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700"
            >
              Exports
            </div>
            <h3 class="text-xl font-semibold text-slate-900">
              Export data to your software
            </h3>
            <p class="text-slate-600">
              Deliver clean data packages to GIS, CAD, BIM, or your cloud
              systems.
            </p>
            <ul class="mt-1 space-y-2 text-sm text-slate-600">
              <li>• Shapefile, GeoJSON, CSV, and KML exports.</li>
              <li>• Webhooks and API for integrations.</li>
              <li>• Inspection reports for stakeholders.</li>
            </ul>
          </article>
        </div>
      </div>
    ...
    <section class="py-12 sm:py-14" id="pricing">
      <div class="mx-auto max-w-6xl px-6">
        <div class="space-y-3">
          <p
            class="inline-flex items-center gap-2 rounded-full bg-teal-100 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-teal-800"
          ...
          >
            ...
            <ul class="space-y-2 text-sm text-slate-700">
              <li class="flex items-center gap-2">
                <span class="text-teal-700">✓</span><span>Mapping</span>
              </li>
              <li class="flex items-center gap-2">
    ...
    <section class="py-12 sm:py-14" id="trusted">
      <div class="mx-auto max-w-6xl px-6">
    ...
    <section class="py-12 sm:py-14" id="contact">
      <div class="mx-auto max-w-6xl px-6">
        <div
      ...
      <div class="mx-auto max-w-6xl px-6">
        ...
        >
          <div class="space-y-3">
            ...
            <p class="text-slate-600">
              Tell us about your utilities, timelines, or GPR needs. We respond
              within one business day with next steps and a tailored plan.
            </p>
            <div class="grid gap-3 sm:grid-cols-2">
              <div
          ...
          <form class="grid gap-3" on:submit={handleContactSubmit}>
            ...
            <div class="grid gap-1">
              ...
              <textarea
                ...
                name="details"
                rows="3"
                placeholder="Utility type, timelines, sites, GPR needs..."
                class="w-full rounded-lg border border-slate-200 px-3 py-2 text-slate-900 outline-none transition focus:border-teal-600 focus:ring-2 focus:ring-teal-100"
              ></textarea>
            </div>
            <button
